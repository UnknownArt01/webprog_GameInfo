...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kalam:wght@700&family=Montserrat:wght@500&display=swap" rel="stylesheet">
...
<body>
    ...
    <nav>
        <div class="logo">
            <a class="logo" href="#"><h4>GameInfo</h4></a>
        </div>
        ...
        <ul>
            ...
            <li><a href="#">News</a></li>
            <li><a class="hotnews" href="#">HOT NEWS!</a></li>
        </ul>
